<?php
/**
 * FinRetornoSegU Active Record
 * @author  <your-name-here>
 */
class FinRetornoSegU extends TRecord
{
    const TABLENAME = 'fin_retorno_seg_u';
    const PRIMARYKEY= 'id';
    ...
    public function __construct($id = NULL, $callObjectLoad = TRUE)
    {
        ...
        parent::addAttribute('id_fin_retornosegt');
    }

    
    /**
     * Method set_fin_retorno
     * Sample of usage: $fin_retorno_seg_u->fin_retorno = $object;
     ...
     * Sample of usage: $fin_retorno_seg_u->fin_retorno->attribute;
     ...
     * Sample of usage: $fin_retorno_seg_u->tipo_movto_retorno = $object;
     ...
     * Sample of usage: $fin_retorno_seg_u->tipo_movto_retorno->attribute;
     ...
     * Sample of usage: $fin_retorno_seg_u->contas_receber = $object;
     ...
     * Sample of usage: $fin_retorno_seg_u->contas_receber->attribute;
