<?php
/**
 * patrulheiroFormList Form List
 * @author  <your name here>
 */
class patrulheiroFormList extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $this->form = new BootstrapFormBuilder('form_patrulheiro');
        ...
        $unidade = new TDBCombo('unidade_id','permission','SystemUnit','id','name', 'name', $criteria);
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new patrulheiro;  // create an empty object
