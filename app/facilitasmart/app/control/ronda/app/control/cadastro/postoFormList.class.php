<?php
/**
 * postoFormList Form List
 * @author  <your name here>
 */
class postoFormList extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $this->form = new BootstrapFormBuilder('form_posto');
        $this->form->setFormTitle('posto');
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for posto
            $repository = new TRepository('Posto');
            $limit = 10;
            // creates a criteria
    ...
    public static function Delete($param)
    {
        try
        {
            ...
            $object = new posto($key, FALSE); // instantiates the Active Record
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new posto;  // create an empty object
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                $key = $param['key'];  // get the parameter $key
                TTransaction::open('ronda'); // open a transaction
                $object = new posto($key); // instantiates the Active Record
