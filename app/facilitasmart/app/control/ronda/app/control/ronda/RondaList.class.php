...
class RondaList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->addFields( [ new TLabel('Data') ], [ $data_ronda ] );
        ...
        $column_status_tratamento = new TDataGridColumn('status_tratamento', 'Status', 'right');
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            if ($objects)
            {
                ...
                foreach ($objects as $object)
                {
                    $object->data_ronda = TDate::date2br($object->data_ronda);
