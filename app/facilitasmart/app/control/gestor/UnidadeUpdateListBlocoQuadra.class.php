<?php
/**
 * UnidadeUpdateListBlocoQuadra Listing
 * @author  <your name here>
 */
class UnidadeUpdateListBlocoQuadra extends TPage
{
    ...
    public function __construct()
    {
        ...
        $column_bloco_quadra = new TDataGridColumn('bloco_quadra_widget', 'Bloco Quadra', 'left');
...
/**
    ...
    public function onBeforeLoad($objects, $param)
    {
        ...
        {
            $object->bloco_quadra_widget = new TEntry('bloco_quadra' . '_' . $object->id);
            $object->bloco_quadra_widget->setValue( $object->bloco_quadra );
            $object->bloco_quadra_widget->setSize('100%');
            $gridfields[] = $object->bloco_quadra_widget; // important
        }
