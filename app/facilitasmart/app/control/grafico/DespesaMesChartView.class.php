 ...
 */
class DespesaMesChartView extends TPage
{
    /**
     * Class constructor
     * Creates the page
    ...
    function __construct( $show_breadcrumb )
    {
        ...
        try
        {
            ...
            $receitas_mes = ContasPagar::getDespesaMes( date('Y'), TSession::getValue('id_condominio') );
            TTransaction::close();
            ...
            $panel = new TPanelGroup('Despesa / mês - ' . date('Y'));
