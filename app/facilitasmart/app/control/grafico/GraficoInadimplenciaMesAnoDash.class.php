 ...
 */
class GraficoInadimplenciaMesAnoDash extends TPage
{
    /**
     * Class constructor
     * Creates the page
    ...
    function __construct( $show_breadcrumb = true )
    {
        ...
        {
            $dados[] = [ $coluna1['mes'].'/'.$coluna1['ano'], (float)$coluna1['valor'] ];
        ...
        $panel = new TPanelGroup('Gráfico Inadimplência Mês - Ano');
        ...
        $html->enableSection('main', array('data'   => json_encode($dados),
                                           'width'  => '100%',
                                           'height'  => '300px',
                                           'title'  => 'Inadimplência Total R$ '. number_format($total_inadimplencia, 2, ',', '.'),
                                           'ytitle' => 'Accesses', 
                                           'xtitle' => 'Day',
                                           'uniqid' => uniqid()));
