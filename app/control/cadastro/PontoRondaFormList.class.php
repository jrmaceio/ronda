<?php
/**
 * PontoRondaFormList Form List
 * @author  <your name here>
 */
class PontoRondaFormList extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $this->form = new BootstrapFormBuilder('form_PontoRonda');
        $this->form->setFormTitle('Ponto de Ronda');
        ...
        $posto_id = new TDBUniqueSearch('posto_id', 'ronda', 'Posto', 'id', 'descricao', 'descricao',$criteria);
        ...
        $this->form->addFields( [ new TLabel('Obrigatório') ], [ $obrigatorio ] );
        $this->form->addFields( [ new TLabel('Coordenada Latitude') ], [ $latitude ] );
        $this->form->addFields( [ new TLabel('Coordenada Longitude') ], [ $longitude ] );
        ...
        $column_intevalo_minutos = new TDataGridColumn('intevalo_minutos', 'Intevalo Minutos', 'left');
        $column_posto_id = new TDataGridColumn('posto->descricao', 'Posto', 'left');
        $column_obrigatorio = new TDataGridColumn('obrigatorio', 'Obrigatório', 'left');
        $column_unidade = new TDataGridColumn('unit->name', 'Unidade', 'left');
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new PontoRonda;  // create an empty object
