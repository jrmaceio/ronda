...
class RondaReport extends TPage
{
    ...
    function __construct()
    {
        ...
        $patrulheiro_id = new TDBUniqueSearch('patrulheiro_id', 'ronda', 'Patrulheiro', 'id', 'nome', 'nome', $criteria);
        
        $criteria = new TCriteria;
        $criteria->add(new TFilter('unidade_id', 'IN', TSession::getValue('userunitids')));
        $ponto_ronda_id = new TDBUniqueSearch('ponto_ronda_id', 'ronda', 'PontoRonda', 'id', 'descricao', 'descricao', $criteria);
